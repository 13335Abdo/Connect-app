...
export default function CommentPopup({ post, isLiked, setIsLiked ,isOpen,setIsOpen }: { post: PostType; isOpen:boolean ; setIsOpen:(v: boolean) => void; isLiked: boolean; setIsLiked: (v: boolean) => void }) {
                ...
                >
                    <div className="bg-white rounded-xl w-full max-w-[55%] max-h-[85vh] flex flex-col shadow-xl overflow-hidden">
                        ...
                        <div className="flex-1 overflow-y-auto p-4">
                            <PostSummary post={post} isLiked={isLiked} onLike={() => setIsLiked(!isLiked)} />
                            <div className="mt-5">
